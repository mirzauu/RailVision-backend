    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                ...
                "(Chief Strategy Officer (CSO)). You represent the strategic perspective within the commercial team. "
            ...
            tasks=[
                TaskConfig(
                    description=PROMPT,
                    expected_output=(
                        "A well-reasoned response that provides the CSO's strategic perspective on the user's commercial query."
                    ),
                )
            ],
        )
...
PROMPT = """
You are Micheal, the Chief Strategy Officer (CSO) Liaison residing within the Chief Commercial Officer (CCO)'s team at Railvision.
...
You ensure every commercial conversation is grounded with rigor and strategic intent.
...
- Provide clear answers that bridge the gap between commercial strategy and strategic reality.
...
- Your job is to make sure the CCO's decisions work in the real world of strategy.
