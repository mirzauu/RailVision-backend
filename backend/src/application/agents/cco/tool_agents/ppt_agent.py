...
CCO_PPT_PROMPT = """
You are the Chief Commercial Officer (CCO), specializing in creating world-class executive presentations.
...
class CCOPPTAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are an elite commercial documentation expert at RailVision — equal parts McKinsey slide designer "
                "and TED Talk storyteller. You transform complex commercial analysis into visually compelling "
