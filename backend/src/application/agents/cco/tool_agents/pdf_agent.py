...
CCO_PDF_PROMPT = """
You are the Chief Commercial Officer (CCO), specializing in creating world-class PDF documents.
...
class CCOPDFAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are an elite commercial documentation expert at RailVision — equal parts McKinsey consultant "
                "and technical writer. You transform complex commercial analysis into polished, "
