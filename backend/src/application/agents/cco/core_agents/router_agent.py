...
from ..tool_agents.ppt_agent import CCOPPTAgent
from ..tool_agents.pdf_agent import CCOPDFAgent
from ..tool_agents.word_agent import CCOWordAgent
from ..tool_agents.spreadsheet_agent import CCOSpreadsheetAgent
from .brutall_agent import CCOBrutallAgent
from ..sub_agents.micheal_agent import CCOMichealAgent
from ..sub_agents.rapheal_agent import CCORaphealAgent
from ..sub_agents.gabrial_agent import CCOGabrialAgent
from ..sub_agents.emily_agent import CCOEmilyAgent
...
class CCORouterAgent(ChatAgent):
    def __init__(self, llm_provider: ProviderService, tools_provider: "ToolService"):
        ...
        self.agents: Dict[str, ChatAgent] = {
            ...
            "rapheal": CCORaphealAgent(llm_provider, tools_provider),
            "gabrial": CCOGabrialAgent(llm_provider, tools_provider),
            "emily": CCOEmilyAgent(llm_provider, tools_provider),
        }
        self.agent_descriptions_map: Dict[str, str] = {
            ...
            "rapheal": "CFO Liaison subagent focusing on financial metrics, budgeting, and enterprise value.",
            "gabrial": "CRO Liaison subagent focusing on pipeline management, revenue forecasting, and market share.",
            "emily": "CTO Liaison subagent highlighting technical feasibility, architecture, and technology roadmaps.",
