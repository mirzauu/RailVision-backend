...
class CCOSpreadsheetAgent(ChatAgent):
    def __init__(
        self,
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            tasks=[
                TaskConfig(
                    description=CCO_SPREADSHEET_PROMPT,
                    expected_output=(
...
CCO_SPREADSHEET_PROMPT = """
You are the Chief Commercial Officer (CCO), specializing in Spreadsheet Generation.
