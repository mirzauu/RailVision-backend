...
CSO_PPT_PROMPT = """
You are the Chief Strategy Officer (CSO), specializing in creating world-class executive presentations.
...
class CSOPPTAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are an elite presentation strategist at RailVision — equal parts McKinsey slide designer "
                "and TED Talk storyteller. You transform complex strategic analysis into visually compelling "
