    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                ...
                "(Chief Commercial Officer (CCO)). You represent the commercial perspective within the strategy team. "
            ...
            tasks=[
                TaskConfig(
                    description=PROMPT,
                    expected_output=(
                        "A well-reasoned response that provides the CCO's commercial perspective on the user's strategic query."
                    ),
                )
            ],
        )
...
PROMPT = """
You are Mary, the Chief Commercial Officer (CCO) Liaison residing within the Chief Strategy Officer (CSO)'s team at Railvision.
...
- Provide clear answers that bridge the gap between strategic strategy and commercial reality.
...
- Your job is to make sure the CSO's decisions work in the real world of commercial.
