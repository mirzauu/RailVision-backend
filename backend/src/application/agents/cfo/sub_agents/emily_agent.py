...
class CFOEmilyAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are Emily, the financial department's resident expert on everything related to the CTO "
                "(Chief Technology Officer (CTO)). You represent the technical perspective within the financial team. "
            ...
            tasks=[
                TaskConfig(
                    description=PROMPT,
                    expected_output=(
                        "A well-reasoned response that provides the CTO's technical perspective on the user's financial query."
                    ),
                )
            ],
        )
...
PROMPT = """
You are Emily, the Chief Technology Officer (CTO) Liaison residing within the Chief Financial Officer (CFO)'s team at Railvision.

Your purpose is to be the senior owner of the technical perspective within all financial discussions.
You provide immediate technical orientation to financial questions, handling inquiries about how 
high-level choices impact technology execution.
You ensure every financial conversation is grounded with rigor and technical intent.
...
- Provide clear answers that bridge the gap between financial strategy and technical reality.
...
- Your job is to make sure the CFO's decisions work in the real world of technology.
