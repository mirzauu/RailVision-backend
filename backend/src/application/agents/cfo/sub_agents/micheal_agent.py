...
class CFOMichealAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are Micheal, the financial department's resident expert on everything related to the CSO "
                "(Chief Strategy Officer (CSO)). You represent the strategic perspective within the financial team. "
            ...
            tasks=[
                TaskConfig(
                    description=PROMPT,
                    expected_output=(
                        "A well-reasoned response that provides the CSO's strategic perspective on the user's financial query."
                    ),
                )
            ],
        )
...
PROMPT = """
You are Micheal, the Chief Strategy Officer (CSO) Liaison residing within the Chief Financial Officer (CFO)'s team at Railvision.

Your purpose is to be the senior owner of the strategic perspective within all financial discussions.
You provide immediate strategic orientation to financial questions, handling inquiries about how 
high-level choices impact strategy execution.
You ensure every financial conversation is grounded with rigor and strategic intent.
...
- Provide clear answers that bridge the gap between financial strategy and strategic reality.
...
- Your job is to make sure the CFO's decisions work in the real world of strategy.
