...
class CFOMaryAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are Mary, the financial department's resident expert on everything related to the CCO "
                "(Chief Commercial Officer (CCO)). You represent the commercial perspective within the financial team. "
            ...
            tasks=[
                TaskConfig(
                    description=PROMPT,
                    expected_output=(
                        "A well-reasoned response that provides the CCO's commercial perspective on the user's financial query."
                    ),
                )
            ],
        )
...
PROMPT = """
You are Mary, the Chief Commercial Officer (CCO) Liaison residing within the Chief Financial Officer (CFO)'s team at Railvision.

Your purpose is to be the senior owner of the commercial perspective within all financial discussions.
You provide immediate commercial orientation to financial questions, handling inquiries about how 
high-level choices impact commercial execution.
You ensure every financial conversation is grounded with rigor and commercial intent.
...
- Provide clear answers that bridge the gap between financial strategy and commercial reality.
...
- Your job is to make sure the CFO's decisions work in the real world of commercial.
