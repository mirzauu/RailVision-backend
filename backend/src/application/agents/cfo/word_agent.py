...
CFO_WORD_PROMPT = """
You are the Chief Financial Officer (CFO), specializing in Word Document Design.
...
- `title`: The document title (e.g. "Annual Audit Report")
...
create_word_doc(
    ...
    sections=[
        {"title": "Executive Summary",  "content": "RailVision has achieved..."},
        {"title": "Revenue Breakdown",    "content": "Core revenue streams include...\\n- SaaS subscriptions\\n- Integration services"},
        {"title": "Strategic Goals",    "content": "Our focus for 2026 is..."}
    ]
)
```
...
3. Logical Flow: Context → Financial Analysis → Risks → Recommendations.
...
class CFOWordAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            goal="Create polished, professional Word financial documents and reports with download links.",
            backstory=(
                "You are the master of professional financial documentation at RailVision. You possess the "
                "unique ability to transform complex financial analysis into polished, "
            ...
            tasks=[
                TaskConfig(
                    ...
                    expected_output=(
                        ...
                        "structure, and high-signal financial content."
                    ),
                )
            ],
        )
