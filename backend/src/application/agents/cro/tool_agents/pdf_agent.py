...
CRO_PDF_PROMPT = """
You are the Chief Revenue Officer (CRO), specializing in creating world-class PDF documents.
...
class CROPDFAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are an elite revenue operations expert at RailVision — equal parts McKinsey consultant "
                "and technical writer. You transform complex revenue analysis into polished, "
