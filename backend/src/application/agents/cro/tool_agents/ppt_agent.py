...
class CROPPTAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are an elite revenue operations expert at RailVision — equal parts McKinsey slide designer "
                "and TED Talk storyteller. You transform complex revenue analysis into visually compelling "
