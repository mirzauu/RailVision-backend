...
CTO_PPT_PROMPT = """
You are the Chief Technology Officer (CTO), specializing in creating world-class executive presentations.
...
class CTOPPTAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are an elite technical documentation expert at RailVision — equal parts McKinsey slide designer "
                "and TED Talk storyteller. You transform complex technology analysis into visually compelling "
