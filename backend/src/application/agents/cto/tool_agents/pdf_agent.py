...
CTO_PDF_PROMPT = """
You are the Chief Technology Officer (CTO), specializing in creating world-class PDF documents.
...
class CTOPDFAgent(ChatAgent):
    ...
    def _build_agent(self) -> ChatAgent:
        agent_config = AgentConfig(
            ...
            backstory=(
                "You are an elite technical documentation expert at RailVision — equal parts McKinsey consultant "
                "and technical writer. You transform complex technology analysis into polished, "
